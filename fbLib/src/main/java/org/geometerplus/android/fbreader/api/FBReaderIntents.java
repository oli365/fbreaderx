...
public abstract class FBReaderIntents {
	...
	public static Intent defaultInternalIntent(Context context, String action) {
		return internalIntent(context,action).addCategory(Intent.CATEGORY_DEFAULT);
	}

	public static Intent internalIntent(Context context,String action) {

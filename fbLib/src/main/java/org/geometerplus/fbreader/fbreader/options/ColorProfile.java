...
public class ColorProfile {
	...
	public static final String COLOR_CFCFCF = "color_cfcfcf";
	public static final String COLOR_C9BFAF = "COLOR_C9BFAF";
	public static final String COLOR_BFA875 = "COLOR_BFA875";
	public static final String COLOR_8AB990 = "COLOR_8AB990";
	public static final String COLOR_294867 = "COLOR_294867";
	public static final String COLOR_59473F = "COLOR_59473F";
	...
	private ColorProfile(String name) {
		...
		if (NIGHT.equals(name)) {
			...
			FooterNGForegroundUnreadOption =
				createOption(name, "FooterNGForegroundUnreadOption", 119, 119, 119);
		} else if (COLOR_CFCFCF.equals(name)) {
...
//			BackgroundOption = createOption(name, "Background", 214, 206, 197);
		...
		} else if (COLOR_C9BFAF.equals(name)) {
			WallpaperOption = new ZLStringOption("Colors", name + ":Wallpaper", "");
			FillModeOption = new ZLEnumOption<ZLPaintContext.FillMode>("Colors", name + ":FillMode",
					ZLPaintContext.FillMode.tile);
			...
			FooterNGForegroundOption = createOption(name, "FooterNGForegroundOption", 187, 187, 187);
			FooterNGForegroundUnreadOption = createOption(name, "FooterNGForegroundUnreadOption", 119, 119, 119);
		} else if (COLOR_BFA875.equals(name)) {
			...
			FooterNGForegroundOption = createOption(name, "FooterNGForegroundOption", 187, 187, 187);
			FooterNGForegroundUnreadOption = createOption(name, "FooterNGForegroundUnreadOption", 119, 119, 119);
		} else if (COLOR_8AB990.equals(name)) {
			WallpaperOption = new ZLStringOption("Colors", name + ":Wallpaper", "");
			FillModeOption = new ZLEnumOption<ZLPaintContext.FillMode>("Colors", name + ":FillMode",
					ZLPaintContext.FillMode.tile);
			...
			FooterNGForegroundOption = createOption(name, "FooterNGForegroundOption", 187, 187, 187);
			FooterNGForegroundUnreadOption = createOption(name, "FooterNGForegroundUnreadOption", 119, 119, 119);
		} else if (COLOR_294867.equals(name)) {
			WallpaperOption = new ZLStringOption("Colors", name + ":Wallpaper", "");
			FillModeOption = new ZLEnumOption<ZLPaintContext.FillMode>("Colors", name + ":FillMode",
					ZLPaintContext.FillMode.tile);
			//背景颜色
			...
			FooterNGForegroundOption = createOption(name, "FooterNGForegroundOption", 187, 187, 187);
			FooterNGForegroundUnreadOption = createOption(name, "FooterNGForegroundUnreadOption", 119, 119, 119);
		} else if (COLOR_59473F.equals(name)) {
			WallpaperOption = new ZLStringOption("Colors", name + ":Wallpaper", "");
			FillModeOption = new ZLEnumOption<ZLPaintContext.FillMode>("Colors", name + ":FillMode",
					ZLPaintContext.FillMode.tile);

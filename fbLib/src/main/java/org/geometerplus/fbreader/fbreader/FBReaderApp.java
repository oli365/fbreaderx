...
public final class FBReaderApp extends ZLApplication {
    ...
    public FBReaderApp(SystemInfo systemInfo, final IBookCollection<Book> collection) {
        ...
        addAction(ActionCode.PAGE_TURN_START, new PageTurnStartAction(this));
        addAction(ActionCode.PAGE_TURNING, new PageTurningAction(this));
        addAction(ActionCode.PAGE_TURNING_END, new PageTurnEndAction(this));
    ...
    private void gotoStoredPosition() {
        ...
        if (myStoredPositionBook == null) return;
